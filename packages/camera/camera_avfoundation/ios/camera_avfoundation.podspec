...
A Flutter plugin to use the camera from your Flutter app.
  ...
  s.public_header_files = 'camera_avfoundation/Sources/camera_avfoundation/**/*.h'
  s.module_map = 'camera_avfoundation/Sources/camera_avfoundation/CameraPlugin.modulemap'
  s.dependency 'Flutter'

  s.platform = :ios, '12.0'
  s.pod_target_xcconfig = { 'DEFINES_MODULE' => 'YES' }
  s.resource_bundles = {'camera_avfoundation_privacy' => ['camera_avfoundation/Sources/camera_avfoundation/PrivacyInfo.xcprivacy']}
end
